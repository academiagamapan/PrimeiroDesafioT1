...
public class Produto {
	...
	private static int idContador = 0; //contador para criação de produtos com ID's únicos
	private String nome;
	private double preco;
	private int quantidade;
	private int idProduto;
	
	//Construtor para adição no estoque
	...
	//Construtor para adição no carrinho de compras (não incrementa no contador do ID do produto)

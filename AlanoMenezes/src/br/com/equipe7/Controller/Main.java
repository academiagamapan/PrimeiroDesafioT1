...
public class Main {
    ...
    private static void comprar() throws InterruptedException {
        ...
        //Verifica se a compra estÃ¡ finalizada
        ...
        do{
            ...
            System.out.printf("%10s************************************************************\n",esp);
            System.out.printf("%10s Digite o código do produto que deseja comprar ou para voltar ao menu principal: ",esp);
            opcao = sc.nextInt();
            ...
            if(opcao != 0){
                ...
                if(x != null){ //Verifica se o produto existe
                    ...
                    if(qtd > x.getQtdEmEstoque()){ //Verifica se existe quantidade suficiente no estoque
                        System.out.printf("%10s Não hÃ¡ estoque suficiente deste produto!!\n ",esp);
                        Thread.sleep(2000);
                        Utils.limparTela();
                    }else{
                        Utils.limparTela();
      ...
      int opcao = 0;
       ...
       cliente.getCompras().setValorTotalDaCompra(calculaValorTotal());
        ...
        do {
            ...
            System.out.printf("%10s 1. Á vista (dinheiro ou pix) tem 20%% de desconto\n ", esp);
            System.out.printf("%10s 2. Á vista no crédito tem 10%% de desconto\n ", esp);
            ...
            System.out.printf("%10s Digite o código do meio de pagamento que vocÃª deseja utilizar: " +
    ...
    private static void mostrarNotaFiscal(int i) throws InterruptedException {
        ...
        System.out.printf("%10sNFC-e nÂº 000000001  SÃ©rie 001       %s      %s\n\n",esp, dataHj,
                horaHj);
